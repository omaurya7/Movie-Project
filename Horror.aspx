<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Horror.aspx.cs" Inherits="project_702.Horror" %>
...
<asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" 
    ...
    <SelectParameters>
        <asp:Parameter DefaultValue="Horror" Name="catagory" Type="String" />
    </SelectParameters>
</asp:SqlDataSource>
</asp:Content>
