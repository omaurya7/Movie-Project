<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Rom.aspx.cs" Inherits="project_702.Rom" %>
...
<asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" 
    ...
    <SelectParameters>
        <asp:Parameter DefaultValue="Romance" Name="catagory" Type="String" />
    </SelectParameters>
</asp:SqlDataSource>
</asp:Content>
