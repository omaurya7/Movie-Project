<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Drama.aspx.cs" Inherits="project_702.Drama" %>
...
<asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" 
    ...
    <SelectParameters>
        <asp:Parameter DefaultValue="Drama" Name="catagory" Type="String" />
    </SelectParameters>
</asp:SqlDataSource>
</asp:Content>
