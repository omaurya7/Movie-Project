<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Comedy.aspx.cs" Inherits="project_702.Comedy" %>
...
<asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" 
    ...
    <SelectParameters>
        <asp:Parameter DefaultValue="Comedy" Name="catagory" Type="String" />
    </SelectParameters>
</asp:SqlDataSource>
</asp:Content>
