<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Home.aspx.cs" Inherits="project_702.Home" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <p>
    <asp:Label ID="Label3" runat="server" Text="Movies in Theater" Font-Size="XX-Large" ></asp:Label>
...
<asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" 
    ...
    <SelectParameters>
        <asp:Parameter DefaultValue="New" Name="catagory" Type="String" />
    </SelectParameters>
</asp:SqlDataSource>
        <br />
    </p>
